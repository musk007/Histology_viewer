...
for case in os.listdir(DATA_DIR):
    ...
    # Create XML copy for original image
    shutil.copy(
    ...
    for filename in os.listdir(case_path):
        ...
        # Create XML copy for mask
        shutil.copy(
            os.path.join(
                static_case,
                f"{mask_name}_dzi.dzi"
            ),
            os.path.join(
                static_case,
                f"{mask_name}_dzi.xml"
            )
        )
        ...
        # Create XML copy for overlay
        shutil.copy(
            os.path.join(
                static_case,
                f"overlay_{mask_name}_dzi.dzi"
            ),
            os.path.join(
                static_case,
                f"overlay_{mask_name}_dzi.xml"
            )
        )